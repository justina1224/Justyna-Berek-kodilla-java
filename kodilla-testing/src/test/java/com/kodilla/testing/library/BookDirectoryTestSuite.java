...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfFiveBooks() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Joanna", "Zieba", "89060612137");
        ArrayList<Book> books = new ArrayList<Book>();
        Book book1 = new Book("Secrets of Alamo", "John Smith", 2008);
        Book book2 = new Book("Secretaries and Directors", "Dilbert Michigan", 2012);
        Book book3 = new Book("Secret life of programmers", "Steve Wolkowitz", 2016);
        Book book4 = new Book("Secrets of Java", "Ian Tenewitch", 2010);
        Book book5 = new Book("Secrets of programming", "John Smith", 2009);
        books.add(book1);
        books.add(book2);
        books.add(book3);
        books.add(book4);
    ...
    @Test
    public void testListBooksInHandsOfOneBookZeroBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Joanna", "Zieba", "89060612137");
