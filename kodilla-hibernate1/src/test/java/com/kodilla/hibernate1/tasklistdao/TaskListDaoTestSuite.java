...
import com.kodilla.hibernate1.task.dao.TaskDao;
...
public class TaskListDaoTestSuite {
    ...
    private static final String DESCRIPTION = "products for dinner";
    private static final String LISTNAME = "ListName";

    @Test
    public void testTaskListDaoFindByListName() {
        //Given
        TaskList taskList = new TaskList("shopping", DESCRIPTION);
        ...
        Assert.assertEquals("shopping", readTaskLists.get(0).getListName());
